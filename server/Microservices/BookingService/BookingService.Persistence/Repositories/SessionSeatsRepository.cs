...
public class SessionSeatsRepository : ISessionSeatsRepository
{
	private readonly IMongoCollection<SessionSeatsEntity> _collection;

	public SessionSeatsRepository(BookingServiceDBContext context)
	{
		_collection = context.GetCollection<SessionSeatsEntity>("Seats");
	}
